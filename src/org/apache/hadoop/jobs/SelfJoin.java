...
public class SelfJoin extends HadoopJobs {
	...
	final private int RedTaskTime = 70;//800;
 ...
 public RunningJob submitAndExec(String JobName, String QueueID){
		...
		String inputPath=ConstantWarehouse.getStringValue("pathToInputFilesBase")+"self/";
