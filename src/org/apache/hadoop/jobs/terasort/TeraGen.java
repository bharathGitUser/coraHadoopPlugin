...
package org.apache.hadoop.jobs.terasort;
 ...
 */
public class TeraGen  extends HadoopJobs {

	/**
	 * An input format that assigns ranges of longs to each mapper.
	 */
	
	final private int MapTaskTime = 10;//120;
	final private int RedTaskTime = 130;//270;
...
private JobConf initConfig(){
		...
		conf.setMapperClass(SortGenMapper.class);
		conf.setOutputKeyClass(Text.class);
		conf.setOutputValueClass(Text.class);
		conf.setInputFormat(RangeInputFormat.class);
		conf.setOutputFormat(TeraOutputFormat.class);
 ...
 public RunningJob submitAndExec(String JobName, String QueueID){
		...
		//setNumberOfRows(conf, 10000000);
		setNumberOfRows(conf, 3000000);
		...
		//String outputPath = Util.pathToOutputFilesBase+ newJob.getjobType()+"/";
